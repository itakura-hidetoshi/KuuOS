...
superstring-emptiness-sbm-checks:
	python3 validators/validate_superstring_emptiness_string_brane_membrane_v0_2.py examples/superstring_emptiness_string_brane_membrane_packet_v0_1.json
	python3 validators/run_superstring_emptiness_string_brane_membrane_cases_v0_2.py validation_cases/superstring_emptiness_string_brane_membrane_validation_cases_v0_1.json
