...
KuuOS maintains five public lanes:
...
The target is exact relational continuity without authority collapse.

Every candidate, state transition, proof surface, memory record, licensed effect and WORLD representation must retain its source, scope, owner, boundary and stop condition.
...
foreground pause, terminate and handover
...
- public governance and non-authority boundaries;
...
```text
short, medium and long horizon sections
