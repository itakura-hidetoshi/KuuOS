...
subsystem versionは独立しています。PlanOS v1.23、DecisionOS v0.6、MemoryOS v1.00、self-organization v0.113を、一つの連続version番号として扱いません。
...
最新の機能統合はPR #1277、MemoryOS v1.00です。機能frontierの基準commitは`7a5c9308cd7089e4ce96d3cbbd8b88f8f6ae26a4`です。
...
README、ROADMAP、runtime rootを、self-organization v0.113、PlanOS v1.23、DecisionOS v0.6、MemoryOS v1.00へ同期します。
