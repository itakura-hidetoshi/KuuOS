...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live connector dispatcher v7.8")
    ...
    result = build_qi_github_actions_pr_live_connector_dispatcher(
        ...
        pr_live_connector_dispatcher_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_CONNECTOR_DISPATCHER_READY" else 1
