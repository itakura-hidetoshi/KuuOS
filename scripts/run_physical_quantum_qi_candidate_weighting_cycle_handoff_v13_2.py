...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi candidate weighting cycle handoff v13.2")
    ...
    result = build_physical_quantum_qi_candidate_weighting_cycle_handoff(
        ...
        candidate_weighting_cycle_handoff_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_CANDIDATE_WEIGHTING_CYCLE_HANDOFF_READY" else 1
