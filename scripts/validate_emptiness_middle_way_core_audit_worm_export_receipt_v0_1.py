...
DOC = ROOT / "docs" / "EMPTINESS_MIDDLE_WAY_CORE_AUDIT_WORM_EXPORT_RECEIPT_v0_1.md"
LEDGER = ROOT / "specs" / "emptiness_middle_way_core_audit_hash_chain_fixture_v0_1.jsonl"
RECEIPT = ROOT / "specs" / "emptiness_middle_way_core_audit_worm_export_receipt_fixture_v0_1.json"
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print(f"PASS: Emptiness Middle Way core audit WORM receipt validated root={root}")
    return 0
