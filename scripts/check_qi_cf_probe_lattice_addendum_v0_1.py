...
MANIFEST = ROOT / "manifests" / "qi_cf_probe_lattice_addendum_v0_1.json"
...
def main() -> int:
    ...
    if m.get("manifest_version") != "qi_cf_probe_lattice_addendum_v0_1":
        errors.append("manifest_version_mismatch")
    if m.get("addendum_status") != "QI_CF_PROBE_LATTICE_ADDENDUM_READY":
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print("PASS: Qi CF probe lattice addendum check")
    return 0
