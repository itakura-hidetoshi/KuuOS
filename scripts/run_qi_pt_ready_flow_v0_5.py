...
from runtime.kuuos_runtime_daemon_qi_pt_ready_flow_v0_5 import build_qi_pt_ready_flow
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi PT ready flow v0.5")
    ...
    result = build_qi_pt_ready_flow(
        runtime_context=read_json(args.context),
        ready_flow_license_packet=read_json(args.license),
    )
    ...
    return 0 if result.ready_flow_status in {
