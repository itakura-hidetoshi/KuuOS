...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi closed-loop path integral re-entry v13.0")
    ...
    result = build_physical_quantum_qi_closed_loop_path_integral_reentry(
        ...
        closed_loop_path_integral_reentry_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_CLOSED_LOOP_PATH_INTEGRAL_REENTRY_READY" else 1
