...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v12.5 to v12.6 transition executor bridge v13.9")
    ...
    result = build_physical_quantum_qi_v12_5_to_v12_6_transition_executor_bridge(
        ...
        v12_5_to_v12_6_transition_executor_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V12_5_TO_V12_6_TRANSITION_EXECUTOR_BRIDGE_READY" else 1
