...
CHECK_MODULES = [
    ...
    "scripts.check_qi_world_os_interface_bridge_v1_0",
    "scripts.check_qi_world_adaptive_trace_adapter_v1_1",
    "scripts.check_qi_world_native_evidence_loop_v1_2",
    "scripts.check_qi_world_native_full_cycle_v1_3",
    "scripts.check_qi_world_native_generational_replan_v1_4",
...
TEST_MODULES = [
    ...
    "tests.test_qi_world_adaptive_trace_adapter_v1_1",
    "tests.test_qi_world_native_evidence_loop_v1_2",
    "tests.test_qi_world_native_full_cycle_v1_3",
    "tests.test_qi_world_native_generational_replan_v1_4",
