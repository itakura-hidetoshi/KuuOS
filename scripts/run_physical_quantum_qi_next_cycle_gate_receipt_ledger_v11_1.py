...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi next-cycle gate receipt ledger v11.1")
    ...
    result = build_physical_quantum_qi_next_cycle_gate_receipt_ledger(
        ...
        next_cycle_gate_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_NEXT_CYCLE_GATE_RECEIPT_LEDGER_READY" else 1
