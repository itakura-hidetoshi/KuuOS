...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.3 to v13.4 integration bridge v13.16")
    ...
    result = build_physical_quantum_qi_v13_3_to_v13_4_integration_bridge(
        runtime_context=read_json(args.context),
        v13_3_to_v13_4_integration_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_3_TO_V13_4_INTEGRATION_BRIDGE_READY" else 1
