...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi process tensor feedback receipt ledger v12.8")
    ...
    result = build_physical_quantum_qi_process_tensor_feedback_receipt_ledger(
        ...
        process_tensor_feedback_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_PROCESS_TENSOR_FEEDBACK_RECEIPT_LEDGER_READY" else 1
