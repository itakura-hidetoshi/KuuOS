...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi forward change runner v2.6")
    ...
    result = build_qi_forward_change_runner(
    ...
    return 0 if result.status == "QI_FORWARD_CHANGE_RUNNER_MERGED" else 1
