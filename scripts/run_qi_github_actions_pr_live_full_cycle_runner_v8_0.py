...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live full cycle runner v8.0")
    ...
    result = build_qi_github_actions_pr_live_full_cycle_runner(
        ...
        pr_live_full_cycle_runner_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_FULL_CYCLE_RUNNER_READY" else 1
