...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live loop runner v7.7")
    ...
    result = build_qi_github_actions_pr_live_loop_runner(
        ...
        pr_live_loop_runner_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_LOOP_RUNNER_READY" else 1
