...
COMMANDS: list[list[str]] = [
    ...
    [sys.executable, "scripts/validate_kuos_emptiness_superposition_non_collapse_release_packet_v0_2.py"],
    [sys.executable, "scripts/validate_kuos_emptiness_superposition_non_collapse_finality_packet_v0_2.py"],
    [sys.executable, "scripts/validate_kuos_emptiness_superposition_non_collapse_established_baseline_packet_v0_2.py"],
    [sys.executable, "scripts/validate_kuos_emptiness_superposition_non_collapse_confirmed_baseline_packet_v0_2.py"],
    [sys.executable, "scripts/validate_kuos_emptiness_superposition_non_collapse_baseline_established_final_packet_v0_2.py"],
