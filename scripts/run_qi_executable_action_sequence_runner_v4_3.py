...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable action sequence runner v4.3")
    ...
    result = build_qi_executable_action_sequence_runner(
    ...
    return 0 if result.status == "QI_EXECUTABLE_ACTION_SEQUENCE_RUNNER_READY" else 1
