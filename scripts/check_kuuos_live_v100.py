...
from scripts.check_kuuos_live_v099 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_local_frontier_finality_v100.json"
REGISTRY = "ci/check_registry.d/repository_local_frontier_finality_v1_00.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v100.json"
