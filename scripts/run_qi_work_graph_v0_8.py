...
from runtime.kuuos_runtime_daemon_qi_work_graph_v0_8 import build_qi_work_graph
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi work graph v0.8")
    ...
    return 0 if result.status in {"QI_WORK_GRAPH_APPLIED", "QI_WORK_GRAPH_REPLAYED", "QI_WORK_GRAPH_IDLE"} else 1
