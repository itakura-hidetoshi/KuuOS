...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live autopilot E2E orchestrator v9.0")
    ...
    result = build_qi_github_actions_pr_live_autopilot_e2e_orchestrator(
        ...
        e2e_orchestrator_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_AUTOPILOT_E2E_ORCHESTRATOR_READY" else 1
