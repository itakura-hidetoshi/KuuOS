...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.7 to v13.8 compatibility bridge v13.20")
    ...
    result = build_physical_quantum_qi_v13_7_to_v13_8_compatibility_bridge(
        runtime_context=read_json(args.context),
        v13_7_to_v13_8_compatibility_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_7_TO_V13_8_COMPATIBILITY_BRIDGE_READY" else 1
