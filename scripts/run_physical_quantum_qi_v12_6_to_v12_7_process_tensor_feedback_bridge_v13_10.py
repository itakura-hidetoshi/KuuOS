...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v12.6 to v12.7 process tensor feedback bridge v13.10")
    ...
    result = build_physical_quantum_qi_v12_6_to_v12_7_process_tensor_feedback_bridge(
        ...
        v12_6_to_v12_7_process_tensor_feedback_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V12_6_TO_V12_7_PROCESS_TENSOR_FEEDBACK_BRIDGE_READY" else 1
