...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi guarded execution intent receipt ledger v12.5")
    ...
    result = build_physical_quantum_qi_guarded_execution_intent_receipt_ledger(
        ...
        guarded_execution_intent_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_GUARDED_EXECUTION_INTENT_RECEIPT_LEDGER_READY" else 1
