...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v12.7 to v12.8 feedback receipt bridge v13.11")
    ...
    result = build_physical_quantum_qi_v12_7_to_v12_8_feedback_receipt_bridge(
        runtime_context=read_json(args.context),
        v12_7_to_v12_8_feedback_receipt_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V12_7_TO_V12_8_FEEDBACK_RECEIPT_BRIDGE_READY" else 1
