...
BUILDER = ROOT / "scripts" / "build_emptiness_middle_way_core_bundle_v0_1.py"
MANIFEST = ROOT / "specs" / "emptiness_middle_way_core_bundle_v0_1.generated.json"
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print("PASS: emptiness middle way core bundle validated")
    return 0
