...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live request planner v7.5")
    ...
    result = build_qi_github_actions_pr_live_request_planner(
        ...
        pr_live_request_planner_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_REQUEST_PLANNER_READY" else 1
