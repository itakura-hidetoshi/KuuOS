...
from runtime.kuuos_github_mcp_sub_issue_chain_parent_cross_observation_v1_1 import CONFIRMATION,VERIFIED,build_github_mcp_sub_issue_chain_canary

def main():
 p=argparse.ArgumentParser(description="Run the reversible KuuOS GitHub MCP three-level sub-issue chain canary with exact nested-parent cross-observation v1.1.")
