...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi integrated candidate to guarded intent bridge v13.6")
    ...
    result = build_physical_quantum_qi_integrated_candidate_to_guarded_intent_bridge(
        ...
        integrated_candidate_to_guarded_intent_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_INTEGRATED_CANDIDATE_TO_GUARDED_INTENT_BRIDGE_READY" else 1
