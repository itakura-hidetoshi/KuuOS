...
def main(argv: list[str] | None = None) -> int:
    ...
    result = build_physical_quantum_qi_v12_5_receipt_to_v12_6_executor_readiness_bridge(
        runtime_context=read_json(args.context),
        v12_5_receipt_to_v12_6_executor_readiness_bridge_license=read_json(args.license),
    )
