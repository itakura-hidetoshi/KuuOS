...
def main() -> int:
    ...
    result = build_physical_quantum_qi_v13_28_closed_loop_reentry_receipt_activation(
        runtime_context=read_json(args.context),
        v13_28_closed_loop_reentry_receipt_activation_license=read_json(args.license),
    )
