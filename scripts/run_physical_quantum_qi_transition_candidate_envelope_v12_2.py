...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi transition candidate envelope v12.2")
    ...
    result = build_physical_quantum_qi_transition_candidate_envelope(
        ...
        transition_candidate_envelope_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_TRANSITION_CANDIDATE_ENVELOPE_READY" else 1
