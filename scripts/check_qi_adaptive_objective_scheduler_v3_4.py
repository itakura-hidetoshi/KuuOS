...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        rc, out, closed = run(root, "invalid_hint", packet({"qi_flow": 0.60, "coherence_score": 0.55, "circulation_pressure": 0.55, "friction": 0.25}, objective_hint="unknown", max_cycles_delta=1), lic())
