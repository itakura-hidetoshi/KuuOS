...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi next-cycle candidate weighting bridge v10.8")
    ...
    result = build_physical_quantum_qi_next_cycle_candidate_weighting_bridge(
        ...
        next_cycle_candidate_weighting_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_NEXT_CYCLE_CANDIDATE_WEIGHTING_BRIDGE_READY" else 1
