...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live external call bridge v8.1")
    ...
    result = build_qi_github_actions_pr_live_external_call_bridge(
        ...
        pr_live_external_call_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_EXTERNAL_CALL_BRIDGE_READY" else 1
