...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable action recipe batch compiler v4.7")
    ...
    result = build_qi_executable_action_recipe_batch_compiler(
    ...
    return 0 if result.status == "QI_EXECUTABLE_ACTION_RECIPE_BATCH_COMPILER_READY" else 1
