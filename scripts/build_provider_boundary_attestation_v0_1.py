...
BUNDLE_BUILDER = ROOT / "scripts" / "build_provider_boundary_bundle_v0_1.py"
BUNDLE_MANIFEST = ROOT / "specs" / "provider_boundary_bundle_v0_1.generated.json"
LEDGER = ROOT / "specs" / "ai_provider_boundary_audit_hash_chain_fixture_v0_1.jsonl"
WORM = ROOT / "specs" / "ai_provider_boundary_audit_worm_export_receipt_fixture_v0_1.json"
OUT = ROOT / "specs" / "provider_boundary_attestation_v0_1.generated.json"
...
def ledger_root() -> str:
    ...
    if not lines:
        raise ValueError("empty provider boundary ledger")
...
def main() -> int:
    ...
    root = ledger_root()
    attestation = {
        "id": "provider_boundary_attestation_v0_1",
        "version": "0.1",
        "generated_at": datetime.datetime.now(datetime.timezone.utc).isoformat().replace("+00:00", "Z"),
        "bundle_manifest_path": "specs/provider_boundary_bundle_v0_1.generated.json",
        "bundle_root_hash": bundle["bundle_root_hash"],
        "audit_hash_chain_path": "specs/ai_provider_boundary_audit_hash_chain_fixture_v0_1.jsonl",
        "audit_hash_chain_root_hash": root,
        "worm_receipt_path": "specs/ai_provider_boundary_audit_worm_export_receipt_fixture_v0_1.json",
