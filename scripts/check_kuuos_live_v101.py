...
from scripts.check_kuuos_live_v100 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_checkpoint_authorization_v101.json"
REGISTRY = "ci/check_registry.d/repository_checkpoint_authorization_v1_01.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v101.json"
