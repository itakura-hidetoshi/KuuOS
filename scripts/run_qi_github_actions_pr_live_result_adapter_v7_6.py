...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live result adapter v7.6")
    ...
    result = build_qi_github_actions_pr_live_result_adapter(
        ...
        pr_live_result_adapter_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_RESULT_ADAPTER_READY" else 1
