...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi guarded execution intent v12.4")
    ...
    result = build_physical_quantum_qi_guarded_execution_intent(
        ...
        guarded_execution_intent_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_GUARDED_EXECUTION_INTENT_READY" else 1
