...
BUILDER = ROOT / "scripts" / "build_kustring_runtime_bundle_v0_2.py"
MANIFEST = ROOT / "specs" / "kustring_runtime_bundle_v0_2.generated.json"
...
def main() -> int:
    ...
    errors: list[str] = []
    if manifest.get("authority_note") != "runtime_integrity_surface_only":
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print(f"PASS: KuString runtime bundle checked root={manifest['bundle_root_hash']}")
    return 0
