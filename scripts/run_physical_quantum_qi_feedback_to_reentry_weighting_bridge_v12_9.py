...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi feedback-to-reentry weighting bridge v12.9")
    ...
    result = build_physical_quantum_qi_feedback_to_reentry_weighting_bridge(
        ...
        feedback_to_reentry_weighting_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_FEEDBACK_TO_REENTRY_WEIGHTING_BRIDGE_READY" else 1
