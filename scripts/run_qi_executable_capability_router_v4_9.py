...
from runtime.kuuos_runtime_daemon_qi_executable_capability_router_v4_9 import build_qi_executable_capability_router
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable capability router v4.9")
    ...
    result = build_qi_executable_capability_router(
        ...
        capability_router_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_EXECUTABLE_CAPABILITY_ROUTER_READY" else 1
