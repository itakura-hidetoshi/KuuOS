...
EXPORTER = ROOT / "scripts" / "export_dependent_origination_runtime_worm_receipt_v0_1.py"
CHAIN = ROOT / "specs" / "dependent_origination_runtime_audit_chain_v0_1.generated.jsonl"
RECEIPT = ROOT / "specs" / "dependent_origination_runtime_worm_receipt_v0_1.generated.json"
FLAGS = [
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print(f"PASS: Dependent Origination runtime WORM receipt checked root={root} entries={count}")
    return 0
