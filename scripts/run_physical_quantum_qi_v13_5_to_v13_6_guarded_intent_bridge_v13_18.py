...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.5 to v13.6 guarded intent bridge v13.18")
    ...
    result = build_physical_quantum_qi_v13_5_to_v13_6_guarded_intent_bridge(
        runtime_context=read_json(args.context),
        v13_5_to_v13_6_guarded_intent_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_5_TO_V13_6_GUARDED_INTENT_BRIDGE_READY" else 1
