...
from scripts.build_codeai_reobservation_bounded_continuation_proposal_gate_fixture_v0_1 import build_reference_fixture
from scripts.project_codeai_reobservation_bounded_continuation_proposal_gate_fixture_v0_1 import project_fixture

ROOT = Path(__file__).resolve().parents[1]
EXAMPLE = ROOT / "examples" / "codeai_reobservation_bounded_continuation_proposal_gate_v0_1.json"
MANIFEST = ROOT / "manifests" / "kuuos_codeai_reobservation_bounded_continuation_proposal_gate_v0_1.json"
