...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.1 to v13.2 cycle handoff bridge v13.14")
    ...
    result = build_physical_quantum_qi_v13_1_to_v13_2_cycle_handoff_bridge(
        runtime_context=read_json(args.context),
        v13_1_to_v13_2_cycle_handoff_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_1_TO_V13_2_CYCLE_HANDOFF_BRIDGE_READY" else 1
