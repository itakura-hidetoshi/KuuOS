...
OUT = ROOT / "specs" / "dependent_origination_runtime_bundle_v0_1.generated.json"

PRECHECKS = [
    [sys.executable, "examples/dependent_origination_runtime_v0_1.py"],
    ...
    [sys.executable, "-m", "unittest", "tests/test_dependent_origination_runtime_v0_1.py"],
]

FILES = [
    "examples/dependent_origination_runtime_v0_1.py",
    "tests/test_dependent_origination_runtime_v0_1.py",
    "specs/dependent_origination_runtime_claims_v0_1.json",
    "scripts/eval_dependent_origination_runtime_claims_v0_1.py",
    "scripts/export_dependent_origination_runtime_audit_v0_1.py",
    "scripts/build_dependent_origination_runtime_audit_chain_v0_1.py",
...
def main() -> int:
    ...
    manifest = {
        "id": "dependent_origination_runtime_bundle_v0_1",
        "version": "0.1",
        "generated_at": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "authority_note": "dependent_origination_runtime_integrity_surface_only",
