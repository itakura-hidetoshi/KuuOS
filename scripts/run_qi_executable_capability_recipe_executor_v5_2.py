...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable capability recipe executor v5.2")
    ...
    result = build_qi_executable_capability_recipe_executor(
        ...
        capability_recipe_executor_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_EXECUTABLE_CAPABILITY_RECIPE_EXECUTOR_READY" else 1
