...
OUT = ROOT / "specs" / "do_sheaf_gauge_runtime_bundle_v0_2.generated.json"
...
FILES = [
    ...
    "tests/test_dependent_origination_sheaf_gauge_runtime_v0_2.py",
    ...
    "scripts/export_do_sheaf_gauge_runtime_audit_v0_2.py",
    "scripts/build_do_sheaf_gauge_runtime_audit_chain_v0_2.py",
    "scripts/check_do_sheaf_gauge_runtime_audit_chain_v0_2.py",
    "scripts/export_do_sheaf_gauge_runtime_worm_receipt_v0_2.py",
    "scripts/check_do_sheaf_gauge_runtime_worm_receipt_v0_2.py",
    "scripts/run_do_sheaf_gauge_runtime_checks_v0_2.py",
...
def main() -> int:
    ...
    manifest = {
        "id": "do_sheaf_gauge_runtime_bundle_v0_2",
        "version": "0.2",
        "generated_at": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "authority_note": "do_sheaf_gauge_runtime_integrity_surface_only",
