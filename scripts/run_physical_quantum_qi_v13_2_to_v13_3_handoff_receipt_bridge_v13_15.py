...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.2 to v13.3 handoff receipt bridge v13.15")
    ...
    result = build_physical_quantum_qi_v13_2_to_v13_3_handoff_receipt_bridge(
        runtime_context=read_json(args.context),
        v13_2_to_v13_3_handoff_receipt_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_2_TO_V13_3_HANDOFF_RECEIPT_BRIDGE_READY" else 1
