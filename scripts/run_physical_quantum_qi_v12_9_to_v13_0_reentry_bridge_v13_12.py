...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v12.9 to v13.0 reentry bridge v13.12")
    ...
    result = build_physical_quantum_qi_v12_9_to_v13_0_reentry_bridge(
        runtime_context=read_json(args.context),
        v12_9_to_v13_0_reentry_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V12_9_TO_V13_0_REENTRY_BRIDGE_READY" else 1
