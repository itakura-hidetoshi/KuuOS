...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi closed-loop re-entry receipt ledger v13.1")
    ...
    result = build_physical_quantum_qi_closed_loop_reentry_receipt_ledger(
        ...
        closed_loop_reentry_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_CLOSED_LOOP_REENTRY_RECEIPT_LEDGER_READY" else 1
