...
BUILDER = ROOT / "scripts" / "build_dependent_origination_runtime_audit_chain_v0_1.py"
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print(f"PASS: Dependent Origination runtime audit chain checked root={prev} entries={len(lines)}")
    return 0
