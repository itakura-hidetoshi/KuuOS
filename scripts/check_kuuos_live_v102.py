...
from scripts.check_kuuos_live_v101 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_atomic_checkpoint_creation_v102.json"
REGISTRY = "ci/check_registry.d/repository_atomic_checkpoint_creation_v1_02.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v102.json"
