...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable action recipe executor v4.5")
    ...
    result = build_qi_executable_action_recipe_executor(
        ...
        recipe_executor_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_EXECUTABLE_ACTION_RECIPE_EXECUTOR_READY" else 1
