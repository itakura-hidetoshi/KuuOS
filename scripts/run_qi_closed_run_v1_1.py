...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi closed run v1.1")
    ...
    result = build_qi_closed_run(
        ...
        closed_license_packet=read_json(args.license),
    )
    ...
    return 0 if result.status in {"QI_CLOSED_RUN_APPLIED", "QI_CLOSED_RUN_IDLE"} else 1
