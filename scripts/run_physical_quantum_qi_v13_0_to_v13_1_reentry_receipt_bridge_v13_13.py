...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.0 to v13.1 reentry receipt bridge v13.13")
    ...
    result = build_physical_quantum_qi_v13_0_to_v13_1_reentry_receipt_bridge(
        runtime_context=read_json(args.context),
        v13_0_to_v13_1_reentry_receipt_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_0_TO_V13_1_REENTRY_RECEIPT_BRIDGE_READY" else 1
