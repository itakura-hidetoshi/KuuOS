...
from scripts.check_kuuos_live_v097 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_repo_ref_receipt_v0_98.json"
REGISTRY = "ci/check_registry.d/repository_reference_update_receipt_v0_98.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v098.json"
