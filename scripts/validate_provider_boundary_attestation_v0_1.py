...
BUILDER = ROOT / "scripts" / "build_provider_boundary_attestation_v0_1.py"
ATTESTATION = ROOT / "specs" / "provider_boundary_attestation_v0_1.generated.json"
BUNDLE = ROOT / "specs" / "provider_boundary_bundle_v0_1.generated.json"
...
DOC = ROOT / "docs" / "PROVIDER_BOUNDARY_ATTESTATION_v0_1.md"
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print("PASS: provider boundary attestation validated")
    return 0
