...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable action dispatcher v4.2")
    ...
    result = build_qi_executable_action_dispatcher(
        ...
        dispatcher_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_EXECUTABLE_ACTION_DISPATCHER_READY" else 1
