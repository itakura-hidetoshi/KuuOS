...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi transition candidate envelope receipt ledger v12.3")
    ...
    result = build_physical_quantum_qi_transition_candidate_envelope_receipt_ledger(
        ...
        transition_candidate_envelope_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_TRANSITION_CANDIDATE_ENVELOPE_RECEIPT_LEDGER_READY" else 1
