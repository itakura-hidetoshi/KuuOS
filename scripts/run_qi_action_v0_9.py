...
def main() -> int:
    ...
    result = build_indra_qi_approved_recovery_action_execution_v0_9(
        ...
        execution_plan=read_json(args.plan),
        execution_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "INDRA_QI_APPROVED_RECOVERY_ACTION_EXECUTION_V0_9_READY" else 1
