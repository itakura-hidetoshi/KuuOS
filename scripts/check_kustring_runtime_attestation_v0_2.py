...
BUILDER = ROOT / "scripts" / "build_kustring_runtime_attestation_v0_2.py"
...
def main() -> int:
    ...
    if att.get("authority_note") != "runtime_attestation_is_integrity_summary_only":
    ...
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 1
    print("PASS: KuString runtime attestation checked")
    return 0
