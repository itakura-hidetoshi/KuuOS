...
CHAIN_BUILDER = ROOT / "scripts" / "build_dependent_origination_runtime_audit_chain_v0_1.py"
CHAIN = ROOT / "specs" / "dependent_origination_runtime_audit_chain_v0_1.generated.jsonl"
OUT = ROOT / "specs" / "dependent_origination_runtime_worm_receipt_v0_1.generated.json"
...
def main() -> int:
    ...
    receipt = {
        "id": "dependent_origination_runtime_worm_receipt_v0_1",
        "version": "0.1",
        "exported_at": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "source_chain": "specs/dependent_origination_runtime_audit_chain_v0_1.generated.jsonl",
        ...
        "authority_note": "dependent_origination_runtime_worm_receipt_is_record_surface_only",
