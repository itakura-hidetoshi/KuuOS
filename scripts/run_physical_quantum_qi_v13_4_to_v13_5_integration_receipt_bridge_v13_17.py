...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi v13.4 to v13.5 integration receipt bridge v13.17")
    ...
    result = build_physical_quantum_qi_v13_4_to_v13_5_integration_receipt_bridge(
        runtime_context=read_json(args.context),
        v13_4_to_v13_5_integration_receipt_bridge_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_V13_4_TO_V13_5_INTEGRATION_RECEIPT_BRIDGE_READY" else 1
