...
from runtime.kuuos_runtime_daemon_qi_filesystem_actuator_v2_0 import build_qi_filesystem_actuator
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi fs v2.0")
    ...
    result = build_qi_filesystem_actuator(
    ...
    return 0 if result.status in {"QI_FILESYSTEM_ACTUATOR_APPLIED", "QI_FILESYSTEM_ACTUATOR_IDLE"} else 1
