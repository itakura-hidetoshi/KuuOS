...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi executable action recipe batch executor v4.6")
    ...
    result = build_qi_executable_action_recipe_batch_executor(
    ...
    return 0 if result.status == "QI_EXECUTABLE_ACTION_RECIPE_BATCH_EXECUTOR_READY" else 1
