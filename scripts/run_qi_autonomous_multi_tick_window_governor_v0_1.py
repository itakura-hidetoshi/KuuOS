...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi autonomous multi-tick window governor v0.1")
    ...
    result = run_qi_autonomous_multi_tick_window_governor(
        ...
        window_context=read_json(args.context),
    )
    ...
    return 0 if result.window_governor_status == "QI_AUTONOMOUS_MULTI_TICK_WINDOW_GOVERNOR_COMPLETED" else 1
