...
from runtime.kuuos_runtime_daemon_qi_process_tensor_flow_policy_v0_4 import build_qi_process_tensor_flow_policy
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi process tensor flow policy v0.4")
    ...
    return 0 if result.policy_status in {
        "QI_PROCESS_TENSOR_FLOW_POLICY_APPLIED",
        "QI_PROCESS_TENSOR_FLOW_POLICY_REPLAYED",
        "QI_PROCESS_TENSOR_FLOW_POLICY_IDLE",
    } else 1
