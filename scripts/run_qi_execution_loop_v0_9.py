...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi execution loop v0.9")
    ...
    result = build_qi_execution_loop(
    ...
    return 0 if result.status in {"QI_EXECUTION_LOOP_APPLIED", "QI_EXECUTION_LOOP_IDLE"} else 1
