...
EXPORTER = ROOT / "scripts" / "export_emptiness_do_two_truths_runtime_audit_v0_1.py"
EVENTS = ROOT / "specs" / "emptiness_do_two_truths_runtime_audit_events_v0_1.generated.jsonl"
...
def main() -> int:
    ...
    prev = "GENESIS"
    entries = []
    rows = [x for x in EVENTS.read_text(encoding="utf-8").splitlines() if x.strip()]
