...
def main() -> int:
    ...
    result = build_indra_qi_recoverability_action_envelope_v0_8(
        ...
        action_plan=read_json(args.plan),
        action_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "INDRA_QI_RECOVERABILITY_ACTION_ENVELOPE_V0_8_READY" else 1
