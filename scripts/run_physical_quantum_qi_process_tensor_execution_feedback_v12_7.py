...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi process tensor execution feedback v12.7")
    ...
    result = build_physical_quantum_qi_process_tensor_execution_feedback(
        ...
        process_tensor_execution_feedback_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_PROCESS_TENSOR_EXECUTION_FEEDBACK_READY" else 1
