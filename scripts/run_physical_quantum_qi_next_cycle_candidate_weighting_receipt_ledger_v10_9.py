...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi next-cycle candidate weighting receipt ledger v10.9")
    ...
    result = build_physical_quantum_qi_next_cycle_candidate_weighting_receipt_ledger(
        ...
        next_cycle_candidate_weighting_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_NEXT_CYCLE_CANDIDATE_WEIGHTING_RECEIPT_LEDGER_READY" else 1
