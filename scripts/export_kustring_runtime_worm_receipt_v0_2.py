...
CHAIN_BUILDER = ROOT / "scripts" / "build_kustring_runtime_audit_chain_v0_2.py"
CHAIN = ROOT / "specs" / "kustring_runtime_audit_chain_v0_2.generated.jsonl"
OUT = ROOT / "specs" / "kustring_runtime_worm_receipt_v0_2.generated.json"
...
def chain_root_and_count() -> tuple[str, int]:
    ...
    return last["entry_hash"], len(lines)
...
def main() -> int:
    ...
    receipt = {
        "id": "kustring_runtime_worm_receipt_v0_2",
        "version": "0.2",
        "exported_at": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "source_chain": "specs/kustring_runtime_audit_chain_v0_2.generated.jsonl",
        ...
        "authority_note": "runtime_worm_receipt_is_record_surface_only",
        **FLAGS,
    }
