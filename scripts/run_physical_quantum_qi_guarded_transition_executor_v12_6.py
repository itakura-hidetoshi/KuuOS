...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi guarded transition executor v12.6")
    ...
    result = build_physical_quantum_qi_guarded_transition_executor(
        ...
        guarded_transition_executor_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_GUARDED_TRANSITION_EXECUTOR_READY" else 1
