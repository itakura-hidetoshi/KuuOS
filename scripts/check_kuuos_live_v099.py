...
from scripts.check_kuuos_live_v098 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_ref_stability_v099.json"
REGISTRY = "ci/check_registry.d/repository_reference_stability_v0_99.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v099.json"
