...
from runtime.kuuos_runtime_daemon_qi_multi_work_v0_7 import build_qi_multi_work
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi multi work v0.7")
    ...
    return 0 if result.status in {"QI_MULTI_WORK_APPLIED", "QI_MULTI_WORK_REPLAYED", "QI_MULTI_WORK_IDLE"} else 1
