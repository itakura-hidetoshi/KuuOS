...
from runtime.kuuos_runtime_daemon_qi_progress_outcome_ledger_v8_0 import build_qi_progress_outcome_ledger
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi progress outcome ledger v8.0")
    ...
    result = build_qi_progress_outcome_ledger(
        runtime_context=read_json(args.context),
        progress_outcome_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_PROGRESS_OUTCOME_LEDGER_READY" else 1
