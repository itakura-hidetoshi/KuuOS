...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions PR live dispatch result collector v7.9")
    ...
    result = build_qi_github_actions_pr_live_dispatch_result_collector(
        ...
        pr_live_dispatch_result_collector_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_PR_LIVE_DISPATCH_RESULT_COLLECTOR_READY" else 1
