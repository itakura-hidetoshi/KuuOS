...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi process tensor cycle runner v3.7")
    ...
    result = build_qi_process_tensor_cycle_runner(
        ...
        cycle_runner_license_packet=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_PROCESS_TENSOR_CYCLE_RUNNER_READY" else 1
