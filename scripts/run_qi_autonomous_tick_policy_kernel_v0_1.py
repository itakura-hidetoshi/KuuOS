...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build Qi autonomous tick policy kernel v0.1")
    ...
    packet = build_qi_autonomous_tick_policy_kernel(
        ...
        policy_context=read_json(args.context),
    )
    ...
    return 0 if packet.policy_status == "QI_AUTONOMOUS_TICK_POLICY_READY" else 1
