...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi circulation closed-loop runner v3.0")
    ...
    result = build_qi_circulation_closed_loop_runner(
    ...
    return 0 if result.status in {"QI_CIRCULATION_CLOSED_LOOP_READY", "QI_CIRCULATION_CLOSED_LOOP_CONVERGED"} else 1
