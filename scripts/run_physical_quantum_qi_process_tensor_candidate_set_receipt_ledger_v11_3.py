...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Physical Quantum Qi process tensor candidate set receipt ledger v11.3")
    ...
    result = build_physical_quantum_qi_process_tensor_candidate_set_receipt_ledger(
        ...
        process_tensor_candidate_set_receipt_ledger_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "PHYSICAL_QUANTUM_QI_PROCESS_TENSOR_CANDIDATE_SET_RECEIPT_LEDGER_READY" else 1
