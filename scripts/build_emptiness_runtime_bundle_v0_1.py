...
OUT = ROOT / "specs" / "emptiness_runtime_bundle_v0_1.generated.json"
...
FILES = [
    "examples/emptiness_runtime_v0_1.py",
    "tests/test_emptiness_runtime_v0_1.py",
    "specs/emptiness_runtime_claims_v0_1.json",
    "scripts/eval_emptiness_runtime_claims_v0_1.py",
    "scripts/export_emptiness_runtime_audit_v0_1.py",
    "scripts/build_emptiness_runtime_audit_chain_v0_1.py",
    "scripts/check_emptiness_runtime_audit_chain_v0_1.py",
    "scripts/export_emptiness_runtime_worm_receipt_v0_1.py",
    "scripts/check_emptiness_runtime_worm_receipt_v0_1.py",
    "scripts/run_emptiness_runtime_checks_v0_1.py",
    "specs/emptiness_runtime_audit_events_v0_1.generated.jsonl",
    "specs/emptiness_runtime_audit_chain_v0_1.generated.jsonl",
...
def main() -> int:
    ...
    manifest = {
        "id": "emptiness_runtime_bundle_v0_1",
        "version": "0.1",
        "generated_at": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "authority_note": "emptiness_runtime_integrity_surface_only",
