...
from scripts.check_kuuos_live_v096 import contract_paths as prior_contract_paths

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_repository_atomic_reference_update_v0_97.json"
REGISTRY = "ci/check_registry.d/repository_atomic_reference_update_v0_97.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repository_runtime_v0_97.json"
