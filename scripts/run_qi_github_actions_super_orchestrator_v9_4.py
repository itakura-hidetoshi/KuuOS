...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Qi GitHub Actions super orchestrator v9.4")
    ...
    result = build_qi_github_actions_super_orchestrator(
        ...
        super_orchestrator_license=read_json(args.license),
    )
    ...
    return 0 if result.status == "QI_GITHUB_ACTIONS_SUPER_ORCHESTRATOR_READY" else 1
