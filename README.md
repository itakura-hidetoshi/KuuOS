...
公開状態のauthoritative branchは`main`です。最新の機能統合はPR #1281、VerifyOS v0.13 Sequential Epistemic Observation Verification Handoffです。この公開面は、そのsquash merge commit `a2423f9d9da06eeab9c560cd3475e48bfc670f35`を基準に同期しています。
...
| VerifyOS | v0.13 independent verification handoff | `docs/VerifyOS/README.md` |
...
subsystem versionは独立しています。ObserveOS v0.7、VerifyOS v0.13、PlanOS v1.23、DecisionOS v0.6、MemoryOS v1.00、self-organization v0.113を、一つの直線的version番号として扱いません。
...
| Versioned specification | `docs/KUUOS_VERIFYOS_SEQUENTIAL_EPISTEMIC_OBSERVATION_VERIFICATION_HANDOFF_v0_1.md` |
| Runtime handoff | `runtime/kuuos_verifyos_sequential_epistemic_observation_verification_handoff_v0_1.py` |
| Route checker | `scripts/check_verifyos_sequential_epistemic_observation_verification_handoff_v0_1.py` |
...
| Dedicated workflow | `.github/workflows/verifyos-sequential-epistemic-observation-verification-handoff-v0-1.yml` |

専用CIはPython surfaces、manifest、全15 routing cases、Evidence Cycle累積回帰、pinned dependency manifest、VerifyOS v0.13 formal root、repository formal aggregateをstrict modeで検証します。
...
| VerifyOS | independent verification handoff and evidence-bound verification |
...
| VerifyOS v0.13 aggregate | `formal/KuuOSVerifyOSV0_13.lean` |
