...
from runtime.kuuos_self_organization_candidate_queue_v0_111 import (
...
class CandidateQueueV0111Test(unittest.TestCase):
    def test_valid(self):
    ...
    def test_path(self):
        self.assertEqual(
            "status/self_organization_candidate_queue_v0_111.json",
            CANDIDATE_QUEUE_PATH,
        )
    ...
    def test_next_pointer(self):
        ...
        self.assertEqual("status/self_organization_candidate_receipt_v0_112.json", data["next_artifact"])
        self.assertEqual("v0.112", data["next_stage"])
