...
from runtime.kuuos_self_organization_next_cycle_seed_v0_110 import (
...
class NextCycleSeedV0110Test(unittest.TestCase):
    def test_valid(self):
    ...
    def test_path(self):
        self.assertEqual(
            "status/self_organization_next_cycle_seed_v0_110.json",
            NEXT_CYCLE_SEED_PATH,
        )
    ...
    def test_seed_fields(self):
        ...
        self.assertEqual("status/self_organization_candidate_queue_v0_111.json", data["next_artifact"])
        self.assertEqual("v0.111", data["next_stage"])
