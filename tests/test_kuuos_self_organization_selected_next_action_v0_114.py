...
from runtime.kuuos_self_organization_selected_next_action_v0_114 import (
...
class SelectedNextActionV0114Test(unittest.TestCase):
    def test_valid(self):
    ...
    def test_path(self):
        self.assertEqual(
            "status/self_organization_selected_next_action_v0_114.json",
            SELECTED_NEXT_ACTION_PATH,
        )
    ...
    def test_selected_candidate(self):
        ...
        self.assertEqual("bounded-change-plan-v0-115", expected_selected_candidate_id())
        self.assertEqual("bounded-change-plan-v0-115", data["selected_candidate_id"])
        self.assertEqual("bounded_change_plan_only", data["selected_candidate_scope"])
        self.assertEqual("v0.115", data["selected_next_stage"])
        self.assertEqual("status/self_organization_bounded_change_plan_v0_115.json", data["next_artifact"])
        self.assertEqual("v0.115", data["next_stage"])
