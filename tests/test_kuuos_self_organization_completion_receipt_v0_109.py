...
from runtime.kuuos_self_organization_completion_receipt_v0_109 import (
...
class CompletionReceiptV0109Test(unittest.TestCase):
    def test_valid(self):
    ...
    def test_path(self):
        self.assertEqual(
            "status/self_organization_completion_receipt_v0_109.json",
            COMPLETION_RECEIPT_PATH,
        )
    ...
    def test_fields(self):
        ...
        self.assertEqual("v0.108", data["completed_stage"])
        self.assertEqual("status/self_organization_next_cycle_seed_v0_110.json", data["next_artifact"])
        self.assertEqual("v0.110", data["next_stage"])
