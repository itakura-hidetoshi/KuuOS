...
noncomputable def storedTriangleCorrectionDifference
...
noncomputable def storedTriangleCorrectionAct
    {R : RawHigherContextualSystem.{u, v, uH, vH} (Context := Context)}
    {H K : HigherLocalizationFactorization (W := W) R}
    {alpha : HigherLocalizationFactorMorphism (W := W) H K}
...
noncomputable def storedTriangleCorrectionTorsorEquiv
    {R : RawHigherContextualSystem.{u, v, uH, vH} (Context := Context)}
    {H K : HigherLocalizationFactorization (W := W) R}
    {alpha : HigherLocalizationFactorMorphism (W := W) H K}
