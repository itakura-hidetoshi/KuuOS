...
in `Sum`, hence in `Type`, so it may be eliminated while constructing
morphisms and isomorphisms; the equality payload then substitutes the index.
-/

private def finTwoCases (i : Fin 2) : Sum (i = 0) (i = 1) :=
