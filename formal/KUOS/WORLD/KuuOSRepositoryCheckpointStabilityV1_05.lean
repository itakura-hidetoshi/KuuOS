...
namespace KUOS.WORLD.KuuOSRepositoryCheckpointStabilityV1_05
...
structure CheckpointStabilityWitness where
  ...
  workspaceFrontierPreserved : Prop
...
structure CheckpointStabilityWitness.ValidStable
  ...
  workspaceFrontierPreserved : w.workspaceFrontierPreserved
...
theorem v105_preserves_v104_workspace_frontier
    (w : CheckpointStabilityWitness)
    (h : w.ValidStable) :
    w.workspaceFrontierPreserved := by
  exact h.workspaceFrontierPreserved
...
end KUOS.WORLD.KuuOSRepositoryCheckpointStabilityV1_05
