...
/-!
Kū–Indra WORLD vacuum central-reference-state bridge v0.53.
...
recovery, excitation vectors, and the v0.50 observation-candidate projection.

"Central" means a common organizing reference. It does not claim that the
vacuum vector, vacuum state, or represented observables lie in the algebraic
center.
-/
...
/-- The recovered channel supplied by the v0.35 Petz bridge. -/
...
theorem local_vacuum_data_processing
    ...
    U.localVacuumRelativeEntropy smaller ≤
      U.localVacuumRelativeEntropy larger := by
