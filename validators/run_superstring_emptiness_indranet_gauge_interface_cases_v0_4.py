#!/usr/bin/env python3
"""Run validation cases for Superstring Emptiness IndraNet Gauge Interface v0.4."""
...
from validate_superstring_emptiness_indranet_gauge_interface_v0_4 import validate  # noqa: E402


def main(argv: List[str]) -> int:
    if len(argv) != 2:
        print("usage: run_superstring_emptiness_indranet_gauge_interface_cases_v0_4.py cases.json", file=sys.stderr)
        return 2
