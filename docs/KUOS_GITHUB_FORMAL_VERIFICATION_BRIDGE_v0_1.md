...
This bridge prevents the following collapse:
...
## 4. KuuOS Repository Role

The KuuOS repository holds:
...
runbooks
runtime contracts
formal invariant bridge surfaces
release and validation policies
```

It does not directly grant final theorem authority.

## 5. 4D Mass Gap Repository Role

The proof-facing repository may hold:
...
audit scripts
CI logs
mathlib adoption gates
replacement closure ledgers
theorem surface milestones
```

It may produce proof evidence, but proof authority remains review-gated.
...
## 8. Required Non-Authority Fixed Points
...
## 9. PR Review Questions for Formal Changes
...
## 10. Bridge to GPT GitHub Integration
...
The integration document defines general GPT GitHub behavior.
This bridge specializes that behavior for formal verification and proof-facing repositories.
