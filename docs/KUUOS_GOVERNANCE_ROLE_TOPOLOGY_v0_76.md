# KuuOS Governance Role Topology v0.76

## 目的

v0.76は、ガバナンスの運用モードと独立承認の要否を分離します。
...
v0.76はv0.74のreview receiptについて次を検査します。
...
v0.76はv0.74のapproval decisionを再実行しません。

## v0.75との関係

v0.75の一回限りcompare-and-swap applicationは変更しません。

v0.76はstate write、live application、permission expansionを行いません。
