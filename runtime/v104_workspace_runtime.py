...
from tests.test_kuuos_repository_checkpoint_evolution_workspace_v1_04 import (
    RepositoryCheckpointEvolutionWorkspaceV104Tests,
)

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_checkpoint_evolution_workspace_v104.json"
REGISTRY = "ci/check_registry.d/repository_checkpoint_evolution_workspace_v1_04.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v104.json"
