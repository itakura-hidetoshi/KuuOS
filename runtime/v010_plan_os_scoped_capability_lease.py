...
from runtime.kuuos_plan_os_capability_lease_scenarios_v0_10 import run_consumption_and_renewal, run_expiry
...
def run_kernel() -> dict:
    with tempfile.TemporaryDirectory(prefix="kuuos-v010-") as temporary:
        ...
        return {
            ...
            "expired": sum(1 for item in expired["leases"].values() if item["status"] == "EXPIRED"),
