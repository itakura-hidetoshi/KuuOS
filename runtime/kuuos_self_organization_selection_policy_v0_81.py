...
from runtime import kuuos_current_root_sequence_v0_80 as current_root
from runtime import kuuos_self_organization_candidate_receipt_v0_80 as receipt

VERSION = "kuuos_self_organization_selection_policy_v0_81"
DEPENDS_ON = receipt.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
SELECTION_POLICY_PATH = "status/self_organization_selection_policy_v0_81.json"
POLICY_SCHEMA_VERSION = "v0.81"
...
def expected_selection_policy() -> dict[str, Any]:
    return {
        ...
        "candidate_receipt_runtime": "runtime/kuuos_self_organization_candidate_receipt_v0_80.py",
        ...
        "ranking_rules": [
            "candidate_must_exist_in_v0_80_receipt",
