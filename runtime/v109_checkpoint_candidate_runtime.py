...
from runtime.v108_checkpoint_namespace_gate_runtime import (
    contract_paths as prior_contract_paths,
)
from runtime.v108_checkpoint_namespace_gate_runtime import (
    run_v108 as run_previous_frontier,
)
from tests.test_kuuos_repository_checkpoint_candidate_v1_09 import (
    RepositoryCheckpointCandidateV109Tests,
)

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_checkpoint_candidate_v109.json"
REGISTRY = "ci/check_registry.d/repo_checkpoint_candidate_v109.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v109.json"
