...
from runtime import kuuos_current_root_sequence_v0_106 as current_root
from runtime import kuuos_self_organization_candidate_queue_v0_104 as queue
from runtime import kuuos_self_organization_candidate_receipt_v0_105 as receipt
from runtime import kuuos_self_organization_selection_policy_v0_106 as policy

VERSION = "kuuos_self_organization_selected_next_action_v0_107"
DEPENDS_ON = policy.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
SELECTED_NEXT_ACTION_PATH = "status/self_organization_selected_next_action_v0_107.json"
SELECTION_SCHEMA_VERSION = "v0.107"
...
CANDIDATE_NEXT_STAGES: dict[str, str] = {
    "candidate-receipt-v0-105": "v0.105",
    "selection-policy-v0-106": "v0.106",
    "selected-next-action-v0-107": "v0.107",
    "bounded-change-plan-v0-108": "v0.108",
}

CANDIDATE_SCOPES: dict[str, str] = {
    "candidate-receipt-v0-105": "candidate_receipt_only",
    "selection-policy-v0-106": "policy_only",
    "selected-next-action-v0-107": "selection_only",
    "bounded-change-plan-v0-108": "bounded_change_plan_only",
}
...
def expected_selected_next_action() -> dict[str, Any]:
    ...
    return {
        ...
        "next_artifact": "status/self_organization_bounded_change_plan_v0_108.json",
        "next_stage": "v0.108",
...
def selected_next_action_issues() -> tuple[str, ...]:
    ...
    if selected.get("next_artifact") != "status/self_organization_bounded_change_plan_v0_108.json":
    ...
    if policy_payload.get("next_stage") != "v0.107":
