...
from runtime import kuuos_current_root_sequence_v0_98 as current_root
from runtime import kuuos_self_organization_candidate_receipt_v0_98 as receipt

VERSION = "kuuos_self_organization_selection_policy_v0_99"
DEPENDS_ON = receipt.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
SELECTION_POLICY_PATH = "status/self_organization_selection_policy_v0_99.json"
POLICY_SCHEMA_VERSION = "v0.99"
...
def expected_selection_policy() -> dict[str, Any]:
    return {
        ...
        "candidate_receipt_runtime": "runtime/kuuos_self_organization_candidate_receipt_v0_98.py",
        "current_root_check": "runtime/kuuos_current_check.py",
        "current_root_sequence": CURRENT_ROOT_SEQUENCE,
        "effect_authorized": False,
        "next_artifact": "status/self_organization_selected_next_action_v0_100.json",
        "next_stage": "v0.100",
        "policy_frontier": VERSION,
        "policy_mode": "policy_only",
        "policy_schema_version": POLICY_SCHEMA_VERSION,
        "ranking_rules": [
            "candidate_must_exist_in_v0_98_receipt",
...
def selection_policy_issues() -> tuple[str, ...]:
    ...
    if policy.get("next_artifact") != "status/self_organization_selected_next_action_v0_100.json":
        issues.append("next_artifact")
    if policy.get("next_stage") != "v0.100":
    ...
    if receipt_payload.get("next_stage") != "v0.99":
