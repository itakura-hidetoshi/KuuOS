...
from runtime import kuuos_current_root_sequence_v0_108 as current_root
from runtime import kuuos_self_organization_bounded_change_plan_v0_108 as bounded_plan

VERSION = "kuuos_self_organization_completion_receipt_v0_109"
DEPENDS_ON = bounded_plan.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
COMPLETION_RECEIPT_PATH = "status/self_organization_completion_receipt_v0_109.json"
COMPLETION_RECEIPT_SCHEMA_VERSION = "v0.109"
...
def expected_completion_receipt() -> dict[str, Any]:
    return {
        ...
        "source_bounded_change_plan_runtime": "runtime/kuuos_self_organization_bounded_change_plan_v0_108.py",
    }
...
def completion_receipt_issues() -> tuple[str, ...]:
    ...
    if receipt.get("completed_stage") != "v0.108":
        issues.append("completed_stage")
    if receipt.get("next_artifact") != "status/self_organization_next_cycle_seed_v0_110.json":
        issues.append("next_artifact")
    if receipt.get("next_stage") != "v0.110":
    ...
    if source.get("planned_next_stage") != "v0.109":
