...
from runtime import kuuos_current_root_sequence_v0_100 as current_root
from runtime import kuuos_self_organization_selected_next_action_v0_100 as selected_action

VERSION = "kuuos_self_organization_bounded_change_plan_v0_101"
DEPENDS_ON = selected_action.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
BOUNDED_CHANGE_PLAN_PATH = "status/self_organization_bounded_change_plan_v0_101.json"
BOUNDED_CHANGE_PLAN_SCHEMA_VERSION = "v0.101"
...
def expected_bounded_change_plan() -> dict[str, Any]:
    return {
        ...
        "planned_artifact": "status/self_organization_completion_receipt_v0_102.json",
        "planned_change_items": [
            "bounded_change_plan_artifact_v0_101",
            "bounded_change_plan_runtime_v0_101",
            "bounded_change_plan_tests_v0_101",
            "current_root_sequence_v0_101",
        ],
        "planned_next_stage": "v0.102",
        "planned_runtime": "runtime/kuuos_self_organization_completion_receipt_v0_102.py",
        "preconditions": [
            "selected_candidate_id_is_bounded_change_plan_v0_101",
        ...
        "selected_next_action_runtime": "runtime/kuuos_self_organization_selected_next_action_v0_100.py",
    }
...
def bounded_change_plan_issues() -> tuple[str, ...]:
    ...
    if plan.get("planned_artifact") != "status/self_organization_completion_receipt_v0_102.json":
        issues.append("planned_artifact")
    if plan.get("planned_next_stage") != "v0.102":
