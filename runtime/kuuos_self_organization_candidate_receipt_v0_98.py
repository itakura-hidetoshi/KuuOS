...
from runtime import kuuos_current_root_sequence_v0_97 as current_root
from runtime import kuuos_self_organization_candidate_queue_v0_97 as queue

VERSION = "kuuos_self_organization_candidate_receipt_v0_98"
DEPENDS_ON = queue.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
CANDIDATE_RECEIPT_PATH = "status/self_organization_candidate_receipt_v0_98.json"
CANDIDATE_RECEIPT_SCHEMA_VERSION = "v0.98"
...
def expected_candidate_receipt() -> dict[str, Any]:
    return {
        ...
        "candidate_queue_runtime": "runtime/kuuos_self_organization_candidate_queue_v0_97.py",
        "current_root_check": "runtime/kuuos_current_check.py",
        "current_root_sequence": CURRENT_ROOT_SEQUENCE,
        "next_artifact": "status/self_organization_selection_policy_v0_99.json",
        "next_stage": "v0.99",
...
def candidate_receipt_issues() -> tuple[str, ...]:
    ...
    if receipt.get("next_artifact") != "status/self_organization_selection_policy_v0_99.json":
        issues.append("next_artifact")
    if receipt.get("next_stage") != "v0.99":
    ...
    if source.get("next_stage") != "v0.98":
