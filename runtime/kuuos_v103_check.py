...
from runtime.kuuos_v102_check import main as run_previous_frontier
from scripts.check_kuuos_live_v102 import contract_paths as prior_contract_paths
...
MANIFEST = "manifests/kuuos_checkpoint_creation_receipt_v103.json"
REGISTRY = "ci/check_registry.d/repository_checkpoint_creation_receipt_v1_03.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v103.json"
...
def contract_paths() -> tuple[str, ...]:
    ...
    for key in ("tests", "validator", "live_contract", "cumulative_runtime", "documentation"):
