...
from runtime import kuuos_current_root_sequence_v0_90 as current_root
from runtime import kuuos_self_organization_candidate_queue_v0_90 as queue

VERSION = "kuuos_self_organization_candidate_receipt_v0_91"
DEPENDS_ON = queue.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
CANDIDATE_RECEIPT_PATH = "status/self_organization_candidate_receipt_v0_91.json"
CANDIDATE_RECEIPT_SCHEMA_VERSION = "v0.91"
...
def expected_candidate_receipt() -> dict[str, Any]:
    return {
        ...
        "candidate_queue_runtime": "runtime/kuuos_self_organization_candidate_queue_v0_90.py",
        "current_root_check": "runtime/kuuos_current_check.py",
        "current_root_sequence": CURRENT_ROOT_SEQUENCE,
        "next_artifact": "status/self_organization_selection_policy_v0_92.json",
        "next_stage": "v0.92",
...
def candidate_receipt_issues() -> tuple[str, ...]:
    ...
    if source.get("next_stage") != "v0.91":
