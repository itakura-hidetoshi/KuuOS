...
from runtime import kuuos_current_root_sequence_v0_89 as current_root
from runtime import kuuos_self_organization_next_cycle_seed_v0_89 as seed

VERSION = "kuuos_self_organization_candidate_queue_v0_90"
DEPENDS_ON = seed.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
CANDIDATE_QUEUE_PATH = "status/self_organization_candidate_queue_v0_90.json"
CANDIDATE_QUEUE_SCHEMA_VERSION = "v0.90"
...
def expected_candidate_queue() -> dict[str, Any]:
    return {
        ...
        "next_artifact": "status/self_organization_candidate_receipt_v0_91.json",
        "next_stage": "v0.91",
        ...
        "seed_runtime": "runtime/kuuos_self_organization_next_cycle_seed_v0_89.py",
    }
...
def candidate_queue_issues() -> tuple[str, ...]:
    ...
    if source.get("next_stage") != "v0.90":
