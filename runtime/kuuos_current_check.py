...
_base.CURRENT_FRONTIER_ARTIFACT = (
    "runtime/kuuos_memoryos_global_word_section_anchor_equivalence_"
    "certificate_kernel_v0_1.py"
)
_NEW_STEP = (
    "memoryos-v0-82-global-word-section-anchor-fiber-equivalence",
    "scripts/check_planos_memoryos_global_word_section_anchor_equivalence_certificate_kernel_v0_1.py",
)
