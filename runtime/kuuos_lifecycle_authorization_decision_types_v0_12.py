...
APPROVED = (
    "LIFECYCLE_BOUNDED_AUTHORIZATION_DECISION_"
    "APPROVED_FOR_SEPARATE_OPERATION_APPROVAL"
)
DENIED = "LIFECYCLE_BOUNDED_AUTHORIZATION_DECISION_DENIED"
REJECTED = "LIFECYCLE_BOUNDED_AUTHORIZATION_DECISION_REJECTED"
OBJECTIVE = "DECIDE_BOUNDED_LIFECYCLE_AUTHORIZATION_ONLY"
...
class LifecycleAuthorizationDecisionEvidenceV012:
    ...
    decision_maker_independence_declaration_digest: str
    decision_maker_independence_declared: bool
    ...
    authorization_decision_expiry_at_epoch_seconds: int
    operation_approval_deadline_at_epoch_seconds: int
    operation_approval_route_digest: str
    operation_approval_route_available: bool
...
class LifecycleAuthorizationDecisionArtifactV012:
    ...
    authorization_decision_record_issued: bool
    authorization_decision_made: bool
    authorization_approved: bool
    authorization_denied: bool
    operation_approval_required_next: bool
    operation_approval_route_required_next: bool
