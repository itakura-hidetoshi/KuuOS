...
VERSION = "kuuos_repository_atomic_reference_update_v0_97"
REFERENCE_UPDATE_COMMITTED = "REPOSITORY_ATOMIC_REFERENCE_UPDATE_COMMITTED"
REFERENCE_UPDATE_ABORTED = "REPOSITORY_ATOMIC_REFERENCE_UPDATE_ABORTED"


@dataclass(frozen=True)
class RepositoryAtomicReferenceUpdatePolicy:
    policy_id: str
...
def repository_atomic_reference_update_policy_digest(
...
@dataclass(frozen=True)
class RepositoryReferenceState:
    state_id: str
    repository_id: str
...
def repository_reference_state_digest(state: RepositoryReferenceState) -> str:
...
@dataclass(frozen=True)
class RepositoryReferenceNonceRegistry:
    registry_id: str
    authority_id: str
...
def repository_reference_nonce_registry_digest(
...
@dataclass(frozen=True)
class RepositoryAtomicReferenceUpdateRequest:
    request_id: str
    transaction_id: str
...
def repository_atomic_reference_update_request_digest(
...
@dataclass(frozen=True)
class RepositoryAtomicReferenceUpdateResult:
    transaction_id: str
    status: str
    authorization_certificate_digest: str
    ...
    current_oid_matches_expected_old: bool
    ...
    reference_update_transition_committed: bool
    reference_state_mutated: bool
    branch_state_updated: bool
    nonce_consumed: bool
...
def repository_atomic_reference_update_result_digest(
