...
def committed_record(*, packet_id: str, atlas_run_id: str, plan: Mapping[str, Any], cycle_index: int, decision: Mapping[str, Any], outcome: Mapping[str, Any], atlas_bundle: Mapping[str, Any], state: Mapping[str, Any]) -> dict[str, Any]:
    packet = {
        ...
        "atlas_state_digest": state.get("atlas_state_digest", ""),
        "record_digest": "",
    }
    packet["record_digest"] = sha(without(packet, "record_digest"))
    return packet
