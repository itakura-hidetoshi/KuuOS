...
from runtime import kuuos_current_root_sequence_v0_88 as current_root
from runtime import kuuos_self_organization_completion_receipt_v0_88 as receipt

VERSION = "kuuos_self_organization_next_cycle_seed_v0_89"
DEPENDS_ON = receipt.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
NEXT_CYCLE_SEED_PATH = "status/self_organization_next_cycle_seed_v0_89.json"
NEXT_CYCLE_SEED_SCHEMA_VERSION = "v0.89"
...
def expected_next_cycle_seed() -> dict[str, Any]:
    return {
        ...
        "completed_cycle_receipt_runtime": "runtime/kuuos_self_organization_completion_receipt_v0_88.py",
        "current_root_check": "runtime/kuuos_current_check.py",
        "current_root_sequence": CURRENT_ROOT_SEQUENCE,
        "next_artifact": "status/self_organization_candidate_queue_v0_90.json",
        ...
        "source_receipt_runtime": "runtime/kuuos_self_organization_completion_receipt_v0_88.py",
    }
