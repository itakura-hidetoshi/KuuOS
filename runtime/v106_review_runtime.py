...
from runtime.kuuos_v105_check import contract_paths as prior_contract_paths
from runtime.kuuos_v105_check import main as run_previous_frontier
from tests.test_kuuos_repository_checkpoint_discrepancy_review_v1_06 import (
    RepositoryCheckpointDiscrepancyReviewV106Tests,
)

ROOT = Path(__file__).resolve().parents[1]
MANIFEST = "manifests/kuuos_checkpoint_discrepancy_review_v106.json"
REGISTRY = "ci/check_registry.d/repo_review_v106.json"
RUNTIME_REGISTRY = "ci/check_registry.d/repo_runtime_v106.json"
