...
from runtime import kuuos_current_root_sequence_v0_92 as current_root
from runtime import kuuos_self_organization_candidate_receipt_v0_91 as receipt
from runtime import kuuos_self_organization_candidate_queue_v0_90 as queue
from runtime import kuuos_self_organization_selection_policy_v0_92 as policy

VERSION = "kuuos_self_organization_selected_next_action_v0_93"
DEPENDS_ON = policy.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
SELECTED_NEXT_ACTION_PATH = "status/self_organization_selected_next_action_v0_93.json"
SELECTION_SCHEMA_VERSION = "v0.93"

COMPLETED_CANDIDATE_IDS: frozenset[str] = frozenset(
    {
        "candidate-receipt-v0-91",
        "selection-policy-v0-92",
        "selected-next-action-v0-93",
    }
)

CANDIDATE_NEXT_STAGES: dict[str, str] = {
    "candidate-receipt-v0-91": "v0.91",
    "selection-policy-v0-92": "v0.92",
    "selected-next-action-v0-93": "v0.93",
    "bounded-change-plan-v0-94": "v0.94",
}

CANDIDATE_SCOPES: dict[str, str] = {
    "candidate-receipt-v0-91": "candidate_receipt_only",
    "selection-policy-v0-92": "policy_only",
    "selected-next-action-v0-93": "selection_only",
    "bounded-change-plan-v0-94": "bounded_change_plan_only",
}
...
def expected_selected_next_action() -> dict[str, Any]:
    ...
    return {
        ...
        "next_artifact": "status/self_organization_bounded_change_plan_v0_94.json",
        "next_stage": "v0.94",
...
def selected_next_action_issues() -> tuple[str, ...]:
    ...
    if selected.get("next_artifact") != "status/self_organization_bounded_change_plan_v0_94.json":
    ...
    if policy_payload.get("next_stage") != "v0.93":
