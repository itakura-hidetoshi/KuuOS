...
from runtime.kuuos_decision_os_wa_kernel_v0_3 import apply_wa_event
...
class WaDecisionStore:
    def __init__(self, root: str | Path) -> None:
        self.root = Path(root)
        self.genesis_path = self.root / "wa-v03-genesis.json"
        self.snapshot_path = self.root / "wa-v03-snapshot.json"
        self.ledger_path = self.root / "wa-v03-ledger.jsonl"
        self.lock_path = self.root / ".decision-os-wa-v03.lock"
