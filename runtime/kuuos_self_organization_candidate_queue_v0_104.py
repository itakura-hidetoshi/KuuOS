...
from runtime import kuuos_current_root_sequence_v0_103 as current_root
from runtime import kuuos_self_organization_next_cycle_seed_v0_103 as seed

VERSION = "kuuos_self_organization_candidate_queue_v0_104"
DEPENDS_ON = seed.VERSION
CURRENT_ROOT_SEQUENCE = current_root.VERSION
CANDIDATE_QUEUE_PATH = "status/self_organization_candidate_queue_v0_104.json"
CANDIDATE_QUEUE_SCHEMA_VERSION = "v0.104"
...
def expected_candidate_queue() -> dict[str, Any]:
    return {
        ...
        "next_artifact": "status/self_organization_candidate_receipt_v0_105.json",
        "next_stage": "v0.105",
        ...
        "seed_runtime": "runtime/kuuos_self_organization_next_cycle_seed_v0_103.py",
    }
...
def candidate_queue_issues() -> tuple[str, ...]:
    ...
    if queue.get("next_artifact") != "status/self_organization_candidate_receipt_v0_105.json":
        issues.append("next_artifact")
    if queue.get("next_stage") != "v0.105":
    ...
    if source.get("next_stage") != "v0.104":
